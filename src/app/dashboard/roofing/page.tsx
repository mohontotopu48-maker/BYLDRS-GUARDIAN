  ...
  return (
    <header className="w-full px-4 sm:px-6 lg:px-10 py-5 flex items-center justify-between">
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
        ...
        <Link
          href="/dashboard"
          className="flex items-center gap-1.5 sm:gap-2 bg-[rgba(201,168,76,0.08)] border border-[rgba(201,168,76,0.15)] rounded-lg px-2 sm:px-3 py-2 hover:bg-[rgba(201,168,76,0.12)] transition-all duration-300"
          aria-label="My Vault"
        >
